...
Resolution: 640 x 360
       # 게임 내부 렌더 해상도 = 640x360
       # → 윈도우 1280x720에서 2x Nearest Neighbor 스케일업
       # 픽셀아트 그리드: 320x180 (AI가 이 밀도로 그림, 2x 업스케일)
Steps: 20~30
Guidance: 3.5~4.0
Sampler: euler
Scheduler: normal
...
```
1. 4장 중 최선 선택
2. 640x360 그대로 사용 (게임 내부 해상도와 동일)
3. 필요 시 밝기/대비 약간 조정
4. PNG 저장 → Assets/Art/Backgrounds/
5. 게임에서 2x Nearest Neighbor 스케일업 → 1280x720 윈도우에 표시
```
